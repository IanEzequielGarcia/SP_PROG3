...
interface  IUsuario
{
    function AltaUsuario(Request $request, Response $response, array $args) : Response;
    function ListarUsuarios(Request $request, Response $response, array $args) : Response;
    function LoginUsuarioJson(Request $request, Response $response, array $args) : Response;
